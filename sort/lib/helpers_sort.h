...
// NOTE: i >= 0 (must exist in the array). j < size of the array. IMPORTANT: j
// cannot BE the length of the array.
void exch(unsigned long long a[], int i, int j);

// is the array a[lo..hi) sorted
// NOTE: is_sorted MUST take the length of the array as the upper bound if you
// intend to check the entire array.
